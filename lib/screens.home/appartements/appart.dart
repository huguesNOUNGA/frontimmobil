...
import 'package:real_estate/screens.home/appartements/detail_screen_appart.dart';


class Appart extends StatefulWidget {
  const Appart({super.key});
...
_buildHouse(BuildContext context, int index){
  ...
  House house = houseListAppart[index];

  return GestureDetector(
    onTap: (){
      Navigator.push(context, MaterialPageRoute(builder: (_) => DetailScreenAppart(house: house)));
    },
  ...
  Widget build(BuildContext context) {
    return Expanded(
      child: ListView.builder(
        ...
        itemCount: houseListAppart.length,
