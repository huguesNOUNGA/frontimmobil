...
class SwiperImagesStudio extends StatefulWidget {
  
  final List<String> imagesListurl;
  SwiperImagesStudio(this.imagesListurl);

  @override
  State<SwiperImagesStudio> createState() => _SwiperImagesStudioState();
}

class _SwiperImagesStudioState extends State<SwiperImagesStudio> {
  @override
